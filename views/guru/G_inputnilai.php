                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url('input_nilaiG/hapus/' . $value->id_nilai) ?>" onclick="return confirm('Apa anda yakin ingin menghapus data ini?')" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i>Delete</a>
                        </td>
                    </tr>
                <?php }  ?>
            </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo form_open('input_nilaiG/tambah'); ?>
                    <div class="form-group">
                        <label>Nama Siswa</label>
                        <input class="form-control" type="text" name="nama_siswa" pattern="^[a-zA-Z ]{6,}" placeholder="Nama Siswa" required>
                        <label>Id Username Siswa</label>
        ...
        <div class="modal fade" id="edit<?= $value->id_nilai ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php echo form_open('input_nilaiG/ubah/' . $value->id_nilai); ?>
                        <div class="form-group">
                            <label>Nama Siswa</label>
                            <input class="form-control" type="text" name="nama_siswa" pattern="^[a-zA-Z ]{6,}" value="<?= $value->nama_siswa ?>" placeholder="Nama Siswa" required>
                            ...
                            <label>UTS</label>
                            <input class="form-control" type="number" name="uts" value="<?= $value->uts ?>" placeholder="uts" required>
                            <label>UAS</label>
                            <input class="form-control" type="number" name="uas" value="<?= $value->uas ?>" placeholder="UAS" required>
