...
<div class="container-fluid">
    ...
    <div class="panel-body">
        ...
        echo form_open_multipart('data_siswa/edit/' . $siswa->id_siswa);
        ?>
        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input class="form-control" value="<?= $siswa->nomor_induk; ?>" type="text" name="nomor_induk" pattern="^[0-9 ]{8,12}" placeholder="Nomor induk" required>
                </div>
            </div>
            <div class="col-6">
                <div class="form-group">
                    <label>Nama Siswa</label>
                    <input class="form-control" type="text" name="nama" value="<?= $siswa->nama ?>" pattern="^[a-zA-Z ]{4,}" placeholder="Nama Guru" required>
                </div>
            </div>
        </div>
        <div class="row">
    ...
    <div class="row">
        <div class="col-6">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="no_telp" value="<?= $siswa->no_telp ?>" pattern="^[0-9 ]{11,13}" placeholder="Nomor Telepon" required>
            </div>
        </div>
    </div>
