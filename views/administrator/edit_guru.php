...
<button type="button" class="close" data-dismiss="alert">&times;</button>', '</div>');
        ...
        echo form_open_multipart('data_guru/edit/' . $guru->id_guru);
        ?>
        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input class="form-control" value="<?= $guru->nomor_induk; ?>" type="text" name="nomor_induk" pattern="^[0-9 ]{8,12}" placeholder="Nomor induk" required>
                </div>
            </div>
            <div class="col-6">
                <div class="form-group">
                    <label>Nama Guru</label>
                    <input class="form-control" type="text" name="nama" value="<?= $guru->nama ?>" pattern="^[a-zA-Z ]{4,}" placeholder="Nama Guru" required>
                </div>
            </div>
        </div>
        <div class="row">
    ...
    <div class="row">
        <div class="col-6">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="no_telp" value="<?= $guru->no_telp ?>" pattern="^[0-9 ]{11,13}" placeholder="Nomor Telepon" required>
            </div>
        </div>
        <div class="col-6">
            <div class="form-group">
